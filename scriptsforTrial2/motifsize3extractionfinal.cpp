...
int main()
{
	...
	string simnum[15] = { "2", "3", "4", "5", "6", "7", "10", "12", "14", "15", "17", "21", "22", "23", "24" };
		//file paths / filenames
								//string folderpath = "D:\\motiftrialtwo\\motif" + simulationnumber + "undirected\\motiffilesinputout\\";  // this is your working directory, CHANGE it to however your file folder system works
	/*motif variable*/		string endfilename = "size3_OUT.txt";																// ending suffix of the files of interest
	string csvfilepath;							//creates the file path of where you will save the file, CHANGE it to whereever you want it to be
	string csvfilename = "_motifSIZE3data.csv";      //this is your output file name, you can CHANGE it to whatever is easier for you to find
		//csvfilepath = folderpath + "simulation" + simulationnumber + csvfilename;
	//ofstream arrayData(csvfilepath);			//creates the outputfile

//motif variables
	/*motif variable*/	const int numberofmotiftypes = 2;  // this number indicates how many motif types there are, CHANGE accordingly to whatever motif size you're extracting
																// for size 3 motifs, there are 2
																// for size 4 motifs, there are 6
																// for size 5 motifs, there are 21
																// for size 6 motifs, there are __
	/*motif variable*/	string search[numberofmotiftypes] = { "78" , "238" };
