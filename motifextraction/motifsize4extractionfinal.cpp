...
int main()
{
	...
	/*motif variable*/		string endfilename = "size4_OUT.txt";																// ending suffix of the files of interest
							string csvfilepath;							//creates the file path of where you will save the file, CHANGE it to whereever you want it to be
							string csvfilename = "_motifSIZE4data.csv";      //this is your output file name, you can CHANGE it to whatever is easier for you to find
								csvfilepath = folderpath + "simulation" + simulationnumber + csvfilename;
							ofstream arrayData(csvfilepath);			//creates the outputfile

	//motif variables
	/*motif variable*/	const int numberofmotiftypes = 6;  // this number indicates how many motif types there are, CHANGE accordingly to whatever motif size you're extracting
																// for size 3 motifs, there are 2
																// for size 4 motifs, there are 6
																// for size 5 motifs, there are 21
																// for size 6 motifs, there are __
	/*motif variable*/	string search[numberofmotiftypes] = { "4382", "4698", "4958", "13260", "13278", "31710" };  // these are the motif id types, CHANGE accordingly to whatever motif size you're extracting
	...
	if (arrayData.is_open())
		...
		cout << "File Failed to Write... (try closing previous .csv file)" << endl;
	//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
