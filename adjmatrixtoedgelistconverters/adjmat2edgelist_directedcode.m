...
filedirectory1 = 'D:\previousPC\school\Research\motif'; 
filedirectory3 = 'undirected';

%file name variables
networkfilename1 = 'Network';
networkfilename3 = '.csv';
temporarylist = {18, 19, 20, 26, 27, 28, 29}; %simulation numbers that is to be analyzed

for j = 1:length(temporarylist)
    
    simualationnumber = num2str(temporarylist{j}); %converts temporarylist to string
    ...
    for k = start :stepsize: timestep %starts at timestep ends at 10000 by steps of 50
        ...
        edge = directed(network); %converts adjacency matrix of network to edgelist using edgelist() function
